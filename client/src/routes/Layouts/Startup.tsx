...
const headerMap: Record<string, TranslationKeys> = {
  '/librechat/login': 'com_auth_welcome_back',
  '/librechat/register': 'com_auth_create_account',
  '/librechat/forgot-password': 'com_auth_reset_password',
  '/librechat/reset-password': 'com_auth_reset_password',
  '/librechat/login/2fa': 'com_auth_verify_your_identity',
};
